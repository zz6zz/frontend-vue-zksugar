...
import type { CreateOrUpdateTableRequestData, DeviceIdData, SensorData, TableData } from "@@/apis/tables/type"
...
const deviceId = ref(null) // 定义响应式变量 deviceId
const device = ref(null) // 定义响应式变量 device
...
<template>
  <div pa-20px h-auto text-center flex select-none all:transition-400>
    <div ma>
